...
export const cCsv = bas.cCs + bas.cv; // Csv
export const cCSV = bas.cCS + bas.cV; // CSV
export const ccss = bas.ccs + bas.cs; // css
export const cCss = bas.cCs + bas.cs; // Css
export const cCSS = bas.cCS + bas.cS; // CSS
...
export const cUri = bas.cUr + bas.ci; // Uri
export const cURI = bas.cUR + bas.cI; // URI
export const cuid = bas.cui + bas.cd; // uid
export const cUid = bas.cUi + bas.cd; // Uid
export const cUID = bas.cUI + bas.cD; // UID
export const cuuid = bas.cuu + bas.cid; // uuid
export const cUuid = bas.cUu + bas.cid; // Uuid
export const cUUID = bas.cUU + bas.cID; // UUID
export const cguid = bas.cgu + bas.cid; // guid
export const cGuid = bas.cGu + bas.cid; // Guid
export const cGUID = bas.cGU + bas.cID; // GUID
...
export const cDotCsv = bas.cDot + cCsv; // .Csv
export const cDotCSV = bas.cDot + cCSV; // .CSV
export const cDotcss = bas.cDot + ccss; // .css
export const cDotCss = bas.cDot + cCss; // .Css
export const cDotCSS = bas.cDot + cCSS; // .CSS
...
export const cApp = bas.cAp + bas.cp; // App
export const cAPP = bas.cAP + bas.cP; // APP
export const cfmk = bas.cfm + bas.ck; // fmk
export const cFmk = bas.cFm + bas.ck; // Fmk
export const cFMK = bas.cFM + bas.cK; // FMK
...
export const cWpm = bas.cWp + bas.cm; // Wpm
export const cWPM = bas.cWP + bas.cM; // WPM
export const cgui = bas.cgu + bas.ci; // gui
export const cGui = bas.cGu + bas.ci; // Gui
export const cGUI = bas.cGU + bas.cI; // GUI
...
export const cIpc = bas.cIp + bas.cc; // Ipc - Inter-Process Communication
export const cIPC = bas.cIP + bas.cC; // IPC - Inter-Process Communication
export const ccli = bas.ccl + bas.ci; // cli - Command Line Interface
export const cCli = bas.cCl + bas.ci; // Cli - Command Line Interface
export const cCLI = bas.cCL + bas.cI; // CLI - Command Line Interface
...
export const cObj = bas.cOb + bas.cj; // Obj
export const cOBJ = bas.cOB + bas.cJ; // OBJ
export const cgpu = bas.cgp + bas.cu; // gpu
export const cGpu = bas.cGp + bas.cu; // Gpu
export const cGPU = bas.cGP + bas.cU; // GPU
export const capu = bas.cap + bas.cu; // apu
export const cApu = bas.cAp + bas.cu; // Apu
export const cAPU = bas.cAP + bas.cU; // APU
export const cfpu = bas.cfp + bas.cu; // fpu
export const cFpu = bas.cFp + bas.cu; // Fpu
export const cFPU = bas.cFP + bas.cU; // FPU
