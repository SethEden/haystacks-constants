...
export const cTruthy = bas.cTr + bas.cut + bas.chy; // cTruthy
export const cFalsy = bas.cF + bas.cal + bas.csy; // cFalsy
export const ctruthy = bas.ctr + bas.cut + bas.chy; // ctruthy
export const cfalsy = bas.cf + bas.cal + bas.csy; // cfalsy
export const cTRUTHY = bas.cTR + bas.cUT + bas.cHY; // cTRUTHY
export const cFALSY = bas.cFA + bas.cLS + bas.cY; // cFALSY
