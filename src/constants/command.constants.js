...
export const cprintCommands = wrd.cprint + wrd.cCommands; // printCommands
export const cprintBusinessRules = wrd.cprint + wrd.cBusiness + wrd.cRules; // printBusinessRules
