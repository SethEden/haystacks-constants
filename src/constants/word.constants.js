...
export const cCompletely = cComplete + bas.cly; // Completely
export const ccompleting = gen.ccom + bas.cp + clet + bas.cly; // completing
export const cCompleting = gen.cCom + bas.cp + clet + bas.cly; // Completing
...
export const cRequiring = bas.cRe + phn.cqui + bas.cr + phn.cing; // Requiring
export const clesson = cless + gen.con; // lesson
export const cLesson = cLess + gen.con; // Lesson
export const cLESSON = cLESS + gen.cON; // LESSON
...
export const cNaturalizes = cNaturalize + bas.cs; // Natrualizes
