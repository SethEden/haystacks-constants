...
export const cAliases = cAlias + bas.ces; // Aliases
export const csequence = phn.cseq + bas.cue + phn.cnce; // sequence
export const cSequence = phn.cSeq + bas.cue + phn.cnce; // Sequence
export const csequences = csequence + bas.cs; // sequences
export const cSequences = cSequence + bas.cs; // Sequences
export const csequenced = csequence + bas.cd; // sequenced
export const cSequenced = cSequence + bas.cd; // Sequenced
export const csequencing = phn.cseq + bas.cue + bas.cnc + phn.cing; // sequencing
export const cSequencing = phn.cSeq + bas.cue + bas.cnc + phn.cing; // Sequencing
