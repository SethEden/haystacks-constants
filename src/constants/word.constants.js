...
export const cWord = bas.cW + phn.cord; // Word
export const cWORD = bas.cWO + bas.cRD; // WORD
...
export const cConfiguration = cConfig + bas.cur + phn.cation; // Configuration
export const cCONFIGURATION = bas.cCO + bas.cNF + bas.cIG + bas.cUR + bas.cAT + phn.cION; // CONFIGURATION
...
export const cADD = bas.cAD + bas.cD; // ADD
export const cadds = c_add + bas.cs; // adds
export const cAdds = cAdd + bas.cs // Adds
export const cadder = c_add + bas.cer; // adder
export const cAdder = cAdd + bas.cer // Adder
...
export const cMESSAGE = bas.cME + bas.cSS + bas.cAG + bas.cE; // MESSAGE
...
export const cSets = cSet + bas.cs; // Sets
export const csetter = cset + phn.cter; // setter
export const cSetter = cSet + phn.cter; // Setter
export const csetting = cset + bas.ct + phn.cing; // setting
export const cSetting = cSet + bas.ct + phn.cing; // Setting
export const csettings = csetting + bas.cs; // settings
export const cSettings = cSetting + bas.cs; // Settings
export const creset = bas.cre + cset; // reset
export const cReset = bas.cRe + cset; // Reset
export const cresets = creset + bas.cs; // resets
export const cResets = cReset + bas.cs; // Resets
export const creseter = creset + bas.cer; // reseter
export const cReseter = cReset + bas.cer; // Reseter
export const cresetting = creset + bas.ct + phn.cing; // resetting
export const cResetting = cReset + bas.ct + phn.cing; // Resetting
...
export const cUsers = cUser + bas.cs; // Users
// smuggle something cused = cuse + bas.cd; // used // These are language reserved words
// smuggle something cUsed = cUse + bas.cd; // Used // These are language reserved words
// smuggle something cusing = cus + phn.cing; // using // These are language reserved words
// smuggle something cUsing = cUs + phn.cing; // Using // These are language reserved words
...
export const cElement = bas.cEl + bas.ce + phn.cment; // Element
export const cELEMENT = bas.cEL + bas.cEM + bas.cEN + bas.cT; // ELEMENT
...
export const cBusiness = bas.cB + phn.cusiness; // Business
export const cBUSINESS = bas.cBU + bas.cSI + phn.cNESS; // BUSINESS
...
export const cFunction = bas.cF + bas.cun + phn.cction; // Function
export const cFUNCTION = bas.cFU + bas.cNC + phn.cTION; // FUNCTION
...
export const cBasic = bas.cB + phn.casic; // Basic
export const cBASIC = bas.cBA + bas.cSI + bas.cC; // BASIC
...
export const cColor = phn.cCol + bas.cor; // Color
export const cCOLOR = bas.cCO + bas.cLO + bas.cR; // COLOR
...
export const cCommanded = cCommand + bas.ced; // Commanded
export const ccommander = ccommand + bas.cer; // commander
export const cCommander = cCommand + bas.cer; // Commander
...
export const cSuccessfully = cSuccessful + bas.cly; // Successfully
export const cunsuccessful = bas.cun + csuccess + phn.cful; // unsuccessful
export const cUnsuccessful = bas.cUn + csuccess + phn.cful; // Unsuccessful
export const cunsuccessfully = bas.cun + csuccessful + bas.cly; // unsuccessfully
export const cUnsuccessfully = bas.cUn + csuccessful + bas.cly; // Unsuccessfully
...
export const cCountry = cCount + bas.cry; // Country
export const cCOUNTRY = bas.cCO + bas.cUN + cTRY; // COUNTRY
export const ccountries = ccount + phn.cries; // countries
export const cCountries = cCount + phn.cries; // Countries
export const cknot = bas.ck + gen.cnot; // knot
export const cKnot = bas.cK + gen.cnot; // Knot
export const cKNOT = bas.cKN + bas.cOT; // KNOT
...
export const cLanguage = phn.cLang + phn.cuage; // Language
export const cLANGUAGE = bas.cLA + bas.cNG + bas.cUA + bas.cGE; // LANGUAGE
...
export const cAnythings = cAnything + bas.cs; // Anythings
export const cinitial = phn.cini + bas.cti + bas.cal; // cinitial
export const cInitial = phn.cIni + bas.cti + bas.cal; // cInitial
...
export const cInitialized = cInitialize + bas.cd; // Initialized
export const cinitialization = cinitial + bas.ciz + bas.ca + phn.ction; // initialization
export const cInitialization = cInitial + bas.ciz + bas.ca + phn.ction; // Initialization
export const cinitializations = cinitial + bas.ciz + bas.ca + phn.ction + bas.cs; // initializations
export const cInitializations = cInitial + bas.ciz + bas.ca + phn.ction + bas.cs; // Initializations
...
export const cExtras = cExtra + bas.cs; // Extras
export const cextract = cextra + bas.cct; // cextract
export const cExtract = cExtra + bas.cct; // cExtract
export const cextracts = cextra + bas.cct + bas.cs; // cextracts
export const cExtracts = cExtra + bas.cct + bas.cs; // cExtracts
export const cextracted = cextra + bas.cct + bas.ced; // cextracted
export const cExtracted = cExtra + bas.cct + bas.ced; // cExtracted
export const cextracting = cextra + bas.cct + gen.cing; // cextracting
export const cExtracting = cExtra + bas.cct + gen.cing; // cExtracting
export const cextractable = cextra + bas.cct + phn.cable; // cextractable
export const cExtractable = cExtra + bas.cct + phn.cable; // cExtractable
export const cextractively = cextra + bas.cct + bas.civ + bas.cel + bas.cy; // cextractively
export const cExtractively = cExtra + bas.cct + bas.civ + bas.cel + bas.cy; // cExtractively
