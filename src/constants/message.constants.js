...
export const cpluginMetaDataKeyIs = wrd.cplugin + wrd.cMetaData + sys.cSpaceIsColonSpace; // pluginMetaDataKey is:
export const cpluginPathUriAtIndex = wrd.cplugin + wrd.cPath + gen.cURI + bas.cSpace + wrd.cat + bas.cSpace + wrd.cindex + bas.cColon + bas.cSpace; // pluginPathURL at index:
...
export const cstorePluginRegistryInDataStoreMessage01 = cERROR_Colon + bas.cSpace + wrd.cThere + bas.cSpace + wrd.cwas + bas.cSpace + bas.ca + bas.cSpace + wrd.cproblem + bas.cSpace + wrd.csaving + bas.cSpace + wrd.cthe + bas.cSpace + wrd.cregistry + bas.cSpace + wrd.cin + bas.cSpace + wrd.cthe + bas.cSpace + bas.cd + bas.cDash + wrd.cdata + bas.cSpace + wrd.cstructure + bas.cColon + bas.cSpace;
export const cErrorRegisterPluginMessage01 = cERROR_Colon + bas.cSpace + wrd.cFailure + bas.cSpace + wrd.cto + bas.cSpace + wrd.cregister + bas.cSpace + wrd.cplugin + bas.cColon + bas.cSpace; // ERROR: Failure to register plugin:
export const cErrorUnRegisterPluginMessage01 = cERROR_Colon + bas.cSpace + wrd.cFailure + bas.cSpace + wrd.cto + wrd.cunregister + bas.cSpace + wrd.cplugin + bas.cColon + bas.cSpace; // ERROR: Failure to unregister plugin:
export const cErrorUnregisterAllPluginsMessage01 = cERROR_Colon + bas.cSpace + wrd.cCould + bas.cSpace + wrd.cnot + bas.cSpace + wrd.cunregister + bas.cSpace + wrd.call + bas.cSpace + wrd.cof + bas.cSpace + wrd.cthe + bas.cSpace + wrd.cplugins + bas.cDot; // ERROR: Could not unregister all of the plugins.
// ERROR: Failure to write out the plugin registry to the plugin path specified by the application: 
export const cErrorSavePluginRegistryMessage01 = cERROR_Colon + bas.cSpace + wrd.cFailure + bas.cSpace + wrd.cto + bas.cSpace + wrd.cwrite + bas.cSpace + wrd.cout + bas.cSpace + wrd.cthe + bas.cSpace + wrd.cplugin + bas.cSpace + wrd.cregistry + bas.cSpace + wrd.cto + bas.cSpace + wrd.cthe + bas.cSpace + wrd.cplugin + bas.cSpace + wrd.cpath + bas.cSpace + wrd.cspecified + bas.cSpace + wrd.cby + bas.cSpace + wrd.cthe + bas.cSpace + wrd.cappication + bas.cColon + bas.cSpace;
...
export const cloadAllPluginsMessage03 = cERROR_Colon + bas.cSpace + wrd.cNo + bas.cSpace + wrd.cplugin + bas.cSpace + wrd.cexecution + bas.cSpace + wrd.cpaths + bas.cSpace + wrd.cor + bas.cSpace + wrd.cplugins + bas.cSpace + wrd.cmetaData  + bas.cSpace + wrd.cwas + wrd.cspecified + bas.cColon + bas.cSpace; // ERROR: No plugin execution paths or plugins metaData was specified:
export const cErrorRegisterPluginCommandMessage01 = cERROR_Colon + bas.cSpace + wrd.cFailure + bas.cSpace + wrd.cto + bas.cSpace + wrd.cregister + bas.cSpace + wrd.cthe + bas.cSpace + wrd.cspecified + bas.cSpace + wrd.cplugin + bas.cComa + bas.cSpace + wrd.cinvalid + bas.cSpace + wrd.cinput + bas.cColon + bas.cSpace; // ERROR: Failure to register the specified plugin, invalid input:
export const cErrorUnregisterPluginCommandMessage01 = cERROR_Colon + bas.cSpace + wrd.cFailure + bas.cSpace + wrd.cto + bas.cSpace + wrd.cunregister + bas.cSpace + wrd.cthe + bas.cSpace + wrd.cspecified + bas.cSpace + wrd.cplugin + bas.cComa + bas.cSpace + wrd.cinvalid + bas.cSpace + wrd.cinput + bas.cColon + bas.cSpace; // ERROR: Failure to unregister the specified plugin, invalid input:
export const cErrorLoadPluginCommandMessage01 = cERROR_Colon + bas.cSpace + wrd.cFailure + bas.cSpace + wrd.cto + bas.cSpace + wrd.cload + bas.cSpace + wrd.cthe + bas.cSpace + wrd.cspecified + wrd.cSpace + wrd.cplugin + bas.cComa + bas.cSpace + wrd.cinvalid + bas.cSpace + wrd.cinput + bas.cColon + bas.cSpace; // ERROR: Failure to load the specified plugin, invalid input:
export const cErrorLoadPluginsCommandMessage01 = cERROR_Colon + bas.cSpace + wrd.cFailure + bas.cSpace + wrd.cto + bas.cSpace + wrd.cload + bas.cSpace + wrd.cthe + bas.cSpace + wrd.cspecified + wrd.cSpace + wrd.cplugins + bas.cComa + bas.cSpace + wrd.cinvalid + bas.cSpace + wrd.cinput + bas.cColon + bas.cSpace; // ERROR: Failure to load the specified plugins, invalid input:
export const cErrorUnloadPluginCommandMessage01 = cERROR_Colon + bas.cSpace + wrd.cFailure + bas.cSpace + wrd.cto + bas.cSpace + wrd.cunload + bas.cSpace + wrd.cthe + bas.cSpace + wrd.cspecified + wrd.cSpace + wrd.cplugin + bas.cComa + bas.cSpace + wrd.cinvalid + bas.cSpace + wrd.cinput + bas.cColon + bas.cSpace; // ERROR: Failure to unload the specified plugin, invalid input:
export const cErrorUnloadPluginsCommandMessage01 = cERROR_Colon + bas.cSpace + wrd.cFailure + bas.cSpace + wrd.cto + bas.cSpace + wrd.cunload + bas.cSpace + wrd.cthe + bas.cSpace + wrd.cspecified + wrd.cSpace + wrd.cplugins + bas.cComa + bas.cSpace + wrd.cinvalid + bas.cSpace + wrd.cinput + bas.cColon + bas.cSpace; // ERROR: Failure to unload the specified plugins, invalid input:
