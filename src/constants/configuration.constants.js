...
export const cdebugFilesModuleFontStyleSetting = cdebugFiles + wrd.cModule + wrd.cFont + wrd.cStyle + wrd.cSetting; // debugFilesModuleFontStyleSetting
export const cdebugFilesFunctionFontStyleSetting = cdebugFiles + wrd.cFunction + wrd.cFont + wrd.cStyle + wrd.cSetting; // debugFilesFunctionFontStyleSetting
export const cdebugFilesMessageFontStyleSetting = cdebugFiles + wrd.cMessage + wrd.cFont + wrd.cStyle + wrd.cSetting; // debugFilesMessageFontStyleSetting
export const cdebugFilesDataFontStyleSetting = cdebugFiles + wrd.cData + wrd.cFont + wrd.cStyle + wrd.cSetting; // debugFilesDataFontStyleSetting
export const cdebugFilesModuleFontColorSetting = cdebugFiles + wrd.cModule + wrd.cFont + wrd.cColor + wrd.cSetting; // debugFilesModuleFontColorSetting
export const cdebugFilesFunctionFontColorSetting = cdebugFiles + wrd.cFunction + wrd.cFont + wrd.cColor + wrd.cSetting; // debugFilesFunctionFontColorSetting
export const cdebugFilesMessageFontColorSetting = cdebugFiles + wrd.cMessage + wrd.cFont + wrd.cColor + wrd.cSetting; // debugFilesMessageFontColorSetting
export const cdebugFilesDataFontColorSetting = cdebugFiles + wrd.cData + wrd.cFont + wrd.cColor + wrd.cSetting; // debugFilesDataFontColorSetting
export const cdebugFilesModuleFontBackgroundColorSetting = cdebugFiles + wrd.cModule + wrd.cFont + wrd.cBackground + wrd.cColor + wrd.cSetting; // debugFilesModuleFontBackgroundColorSetting
export const cdebugFilesFunctionFontBackgroundColorSetting = cdebugFiles + wrd.cFunction + wrd.cFont + wrd.cBackground + wrd.cColor + wrd.cSetting; // debugFilesFunctionFontBackgroundColorSetting
export const cdebugFilesMessageFontBackgroundColorSetting = cdebugFiles + wrd.cMessage + wrd.cFont + wrd.cBackground + wrd.cColor + wrd.cSetting; // debugFilesMessageFontBackgroundColorSetting
export const cdebugFilesDataFontBackgroundColorSetting = cdebugFiles + wrd.cData + wrd.cFont + wrd.cBackground + wrd.cColor + wrd.cSetting; // debugFilesDataFontBackgroundColorSetting
export const cdebugFunctionsModuleFontStyleSetting = cdebugFunctions + wrd.cModule + wrd.cFont + wrd.cStyle + wrd.cSetting; // debugFunctionsModuleFontStyleSetting
export const cdebugFunctionsFunctionFontStyleSetting = cdebugFunctions + wrd.cFunction + wrd.cFont + wrd.cStyle + wrd.cSetting; // debugFunctionsFunctionFontStyleSetting
export const cdebugFunctionsMessageFontStyleSetting = cdebugFunctions + wrd.cMessage + wrd.cFont + wrd.cStyle + wrd.cSetting; // debugFunctionsMessageFontStyleSetting
export const cdebugFunctionsDataFontStyleSetting = cdebugFunctions + wrd.cData + wrd.cFont + wrd.cStyle + wrd.cSetting; // debugFunctionsDataFontStyleSetting
export const cdebugFunctionsModuleFontColorSetting = cdebugFunctions + wrd.cModule + wrd.cFont + wrd.cColor + wrd.cSetting; // debugFunctionsModuleFontColorSetting
export const cdebugFunctionsFunctionFontColorSetting = cdebugFunctions + wrd.cFunction + wrd.cFont + wrd.cColor + wrd.cSetting; // debugFunctionsFunctionFontColorSetting
export const cdebugFunctionsMessageFontColorSetting = cdebugFunctions + wrd.cMessage + wrd.cFont + wrd.cColor + wrd.cSetting; // debugFunctionsMessageFontColorSetting
export const cdebugFunctionsDataFontColorSetting = cdebugFunctions + wrd.cData + wrd.cFont + wrd.cColor + wrd.cSetting; // debugFunctionsDataFontColorSetting
export const cdebugFunctionsModuleFontBackgroundColorSetting = cdebugFunctions + wrd.cModule + wrd.cFont + wrd.cBackground + wrd.cColor + wrd.cSetting; // debugFunctionsModuleFontBackgroundColorSetting
export const cdebugFunctionsFunctionFontBackgroundColorSetting = cdebugFunctions + wrd.cFunction + wrd.cFont + wrd.cBackground + wrd.cColor + wrd.cSetting; // debugFunctionsFunctionFontBackgroundColorSetting
export const cdebugFunctionsMessageFontBackgroundColorSetting = cdebugFunctions + wrd.cMessage + wrd.cFont + wrd.cBackground + wrd.cColor + wrd.cSetting; // debugFunctionsMessageFontBackgroundColorSetting
export const cdebugFunctionsDataFontBackgroundColorSetting = cdebugFunctions + wrd.cData + wrd.cFont + wrd.cBackground + wrd.cColor + wrd.cSetting; // debugFunctionsDataFontBackgroundColorSetting
