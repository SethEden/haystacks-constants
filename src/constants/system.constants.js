...
export const cPluginWorkflows = wrd.cPlugin + wrd.cWorkflows; // PluginWorkflows
...
export const cBasicConstantsValidation = wrd.cBasic + cConstantsValidation; // BasicConstantsValidation
export const cBusinessConstantsValidation = wrd.cBusiness + cConstantsValidation; // BusinessConstantsValidation
export const cColorConstantsValidation = wrd.cColor + cConstantsValidation; // ColorConstantsValidation
export const cCommandConstantsValidation = wrd.cCommand + cConstantsValidation; // CommandConstantsValidation
export const cConfigurationConstantsValidation = wrd.cConfiguration + cConstantsValidation; // ConfigurationConstantsValidation
export const cCountryConstantsValidation = wrd.cCountry + cConstantsValidation; // CountryConstantsValidation
export const cElementConstantsValidation = wrd.cElement + cConstantsValidation; // ElementConstantsValidation
export const cFunctionConstantsValidation = wrd.cFunction + cConstantsValidation; // FunctionConstantsValidation
export const cGenericConstantsValidation = wrd.cGeneric + cConstantsValidation; // GenericConstantsValidation
export const cIsotopeConstantsValidation = wrd.cIsotope + cConstantsValidation; // IsotopeConstantsValidation
export const cKnotConstantsValidation = wrd.cKnot + cConstantsValidation; // KnotConstantsValidation
export const cLanguageConstantsValidation = wrd.cLanguage + cConstantsValidation; // LanguageConstantsValidation
export const cMessageConstantsValidation = wrd.cMessage + cConstantsValidation; // MessageConstantsValidation
export const cNumericConstantsValidation = wrd.cNumeric + cConstantsValidation; // NumericConstantsValidation
export const cPhonicConstantsValidation = wrd.cPhonic + cConstantsValidation; // PhonicConstantsValidation
export const cShapeConstantsValidation = wrd.cShape + cConstantsValidation; // ShapeConstantsValidation
export const cSystemConstantsValidation = wrd.cSystem + cConstantsValidation; // SystemConstantsValidation
export const cUnitConstantsValidation = wrd.cUnit + cConstantsValidation; // UnitConstantsValidation
export const cWordConstantsValidation = wrd.cWord + cConstantsValidation; // WordConstantsValidation
export const cpluginBusinessConstantsValidation = wrd.cplugin + wrd.cBusiness + cConstantsValidation; // pluginBusinessConstantsValidation
...
export const cpluginMessageConstantsValidation = wrd.cplugin + wrd.cMessage + cConstantsValidation; // pluginMessageConstantsValidation
export const cpluginSystemConstantsValidation = wrd.cplugin + wrd.cSystem + cConstantsValidation; // pluginSystemConstantsValidation
