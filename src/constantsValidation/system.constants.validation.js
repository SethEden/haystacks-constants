...
export const systemConstantsValidation = [
  ...
  {Name: 'cCheckBox', Actual: sys.cCheckBox, Expected: 'CheckBox'},
  {Name: 'cCHECKBOX', Actual: sys.cCHECKBOX, Expected: 'CHECKBOX'},
  {Name: 'clistbox', Actual: sys.clistbox, Expected: 'listbox'},
  {Name: 'cListbox', Actual: sys.cListbox, Expected: 'Listbox'},
  {Name: 'cListBox', Actual: sys.cListBox, Expected: 'ListBox'},
  {Name: 'cLISTBOX', Actual: sys.cLISTBOX, Expected: 'LISTBOX'},
  {Name: 'ccombo', Actual: sys.ccombo, Expected: 'combo'},
  {Name: 'cCombo', Actual: sys.cCombo, Expected: 'Combo'},
  {Name: 'cCOMBO', Actual: sys.cCOMBO, Expected: 'COMBO'},
  {Name: 'ccombobox', Actual: sys.ccombobox, Expected: 'combobox'},
  {Name: 'cCombobox', Actual: sys.cCombobox, Expected: 'Combobox'},
  {Name: 'cComboBox', Actual: sys.cComboBox, Expected: 'ComboBox'},
  {Name: 'cCOMBOBOX', Actual: sys.cCOMBOBOX, Expected: 'COMBOBOX'},
  ...
  // Browsers
  {Name: 'cchrome', Actual: sys.cchrome, Expected: 'chrome'},
  {Name: 'cChrome', Actual: sys.cChrome, Expected: 'Chrome'},
  {Name: 'cCHROME', Actual: sys.cCHROME, Expected: 'CHROME'},
  {Name: 'cedge', Actual: sys.cedge, Expected: 'edge'},
  {Name: 'cEdge', Actual: sys.cEdge, Expected: 'Edge'},
  {Name: 'cEDGE', Actual: sys.cEDGE, Expected: 'EDGE'},
  {Name: 'cfirefox', Actual: sys.cfirefox, Expected: 'firefox'},
  {Name: 'cFirefox', Actual: sys.cFirefox, Expected: 'Firefox'},
  {Name: 'cFIREFOX', Actual: sys.cFIREFOX, Expected: 'FIREFOX'},
  {Name: 'copera', Actual: sys.copera, Expected: 'opera'},
  {Name: 'cOpera', Actual: sys.cOpera, Expected: 'Opera'},
  {Name: 'cOPERA', Actual: sys.cOPERA, Expected: 'OPERA'},
  {Name: 'csafari', Actual: sys.csafari, Expected: 'safari'},
  {Name: 'cSafari', Actual: sys.cSafari, Expected: 'Safari'},
  {Name: 'cSAFARI', Actual: sys.cSAFARI, Expected: 'SAFARI'},
  {Name: 'cvivaldi', Actual: sys.cvivaldi, Expected: 'vivaldi'},
  {Name: 'cVivaldi', Actual: sys.cVivaldi, Expected: 'Vivaldi'},
  {Name: 'cVIVALDI', Actual: sys.cVIVALDI, Expected: 'VIVALDI'},
  {Name: 'cbrave', Actual: sys.cbrave, Expected: 'brave'},
  {Name: 'cBrave', Actual: sys.cBrave, Expected: 'Brave'},
  {Name: 'cBRAVE', Actual: sys.cBRAVE, Expected: 'BRAVE'},
  {Name: 'cinternetExplorer', Actual: sys.cinternetExplorer, Expected: 'internet Explorer'},
  {Name: 'cInternetExplorer', Actual: sys.cInternetExplorer, Expected: 'Internet Explorer'},
  {Name: 'cINTERNETEXPLORER', Actual: sys.cINTERNETEXPLORER, Expected: 'INTERNET EXPLORER'},
  {Name: 'cchromium', Actual: sys.cchromium, Expected: 'chromium'},
  {Name: 'cChromium', Actual: sys.cChromium, Expected: 'Chromium'},
  {Name: 'cCHROMIUM', Actual: sys.cCHROMIUM, Expected: 'CHROMIUM'},
  {Name: 'ctorBrowser', Actual: sys.ctorBrowser, Expected: 'torBrowser'},
  {Name: 'cTorBrowser', Actual: sys.cTorBrowser, Expected: 'TorBrowser'},
  {Name: 'cTORBROWSER', Actual: sys.cTORBROWSER, Expected: 'TORBROWSER'},
  {Name: 'cmaxthon', Actual: sys.cmaxthon, Expected: 'maxthon'},
  {Name: 'cMaxthon', Actual: sys.cMaxthon, Expected: 'Maxthon'},
  {Name: 'cMAXTHON', Actual: sys.cMAXTHON, Expected: 'MAXTHON'},
  {Name: 'cwaterfox', Actual: sys.cwaterfox, Expected: 'waterfox'},
  {Name: 'cWaterfox', Actual: sys.cWaterfox, Expected: 'Waterfox'},
  {Name: 'cWATERFOX', Actual: sys.cWATERFOX, Expected: 'WATERFOX'},
  {Name: 'cseaMonkey', Actual: sys.cseaMonkey, Expected: 'seaMonkey'},
  {Name: 'cSeaMonkey', Actual: sys.cSeaMonkey, Expected: 'SeaMonkey'},
  {Name: 'cSEAMONKEY', Actual: sys.cSEAMONKEY, Expected: 'SEAMONKEY'},
  {Name: 'cepic', Actual: sys.cepic, Expected: 'epic'},
  {Name: 'cEpic', Actual: sys.cEpic, Expected: 'Epic'},
  {Name: 'cEPIC', Actual: sys.cEPIC, Expected: 'EPIC'},
  {Name: 'cmidori', Actual: sys.cmidori, Expected: 'midori'},
  {Name: 'cMidori', Actual: sys.cMidori, Expected: 'Midori'},
  {Name: 'cMIDORI', Actual: sys.cMIDORI, Expected: 'MIDORI'},
  {Name: 'cUCBrowser', Actual: sys.cUCBrowser, Expected: 'UCBrowser'},
  {Name: 'cUCBROWSER', Actual: sys.cUCBROWSER, Expected: 'UCBROWSER'},
  {Name: 'coperaGX', Actual: sys.coperaGX, Expected: 'operaGX'},
  {Name: 'cOperaGX', Actual: sys.cOperaGX, Expected: 'OperaGX'},
  {Name: 'cOPERAGX', Actual: sys.cOPERAGX, Expected: 'OPERAGX'},
  {Name: 'cyandexBrowser', Actual: sys.cyandexBrowser, Expected: 'yandexBrowser'},
  {Name: 'cYandexBrowser', Actual: sys.cYandexBrowser, Expected: 'YandexBrowser'},
  {Name: 'cYANDEXBROWSER', Actual: sys.cYANDEXBROWSER, Expected: 'YANDEXBROWSER'},
  {Name: 'ccomodoDragon', Actual: sys.ccomodoDragon, Expected: 'comodoDragon'},
  {Name: 'cComodoDragon', Actual: sys.cComodoDragon, Expected: 'ComodoDragon'},
  {Name: 'cCOMODODRAGON', Actual: sys.cCOMODODRAGON, Expected: 'COMODODRAGON'},
  {Name: 'ccomodoIceDragon', Actual: sys.ccomodoIceDragon, Expected: 'comodoIceDragon'},
  {Name: 'cComodoIceDragon', Actual: sys.cComodoIceDragon, Expected: 'ComodoIceDragon'},
  {Name: 'cCOMODOICEDRAGON', Actual: sys.cCOMODOICEDRAGON, Expected: 'COMODOICEDRAGON'},
  {Name: 'cfirefoxFocus', Actual: sys.cfirefoxFocus, Expected: 'firefoxFocus'},
  {Name: 'cFirefoxFocus', Actual: sys.cFirefoxFocus, Expected: 'FirefoxFocus'},
  {Name: 'cFIREFOXFOCUS', Actual: sys.cFIREFOXFOCUS, Expected: 'FIREFOXFOCUS'},
  {Name: 'calohaBrowser', Actual: sys.calohaBrowser, Expected: 'alohaBrowser'},
  {Name: 'cAlohaBrowser', Actual: sys.cAlohaBrowser, Expected: 'AlohaBrowser'},
  {Name: 'cALOHABROWSER', Actual: sys.cALOHABROWSER, Expected: 'ALOHABROWSER'},
  {Name: 'cwebkit', Actual: sys.cwebkit, Expected: 'webkit'},
  {Name: 'cWebkit', Actual: sys.cWebkit, Expected: 'Webkit'},
  {Name: 'cWebKit', Actual: sys.cWebKit, Expected: 'WebKit'},
  {Name: 'cWEBKIT', Actual: sys.cWEBKIT, Expected: 'WEBKIT'},
  ...
  {Name: 'ccommandsMetaData', Actual: sys.ccommandsMetaData, Expected: 'commandsMetaData'},
  ...
  {Name: 'cframeworkSchemasPath', Actual: sys.cframeworkSchemasPath, Expected: 'resources//schemas//'},
