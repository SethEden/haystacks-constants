...
export const messageConstantsVaidation = [
  ...
  {Name: 'cvalidationFileNameInputArrayIs',Actual: msg.cvalidationFileNameInputArrayIs, Expected: 'validationFileNameInputArray is: '},
  {Name: 'cvalidationFileNameConfirmedArrayIs',Actual: msg.cvalidationFileNameConfirmedArrayIs, Expected: 'validationFileNameConfirmedArray is: '}, 
  {Name: 'cvalidationFileNameConfirmedListIs',Actual: msg.cvalidationFileNameConfirmedListIs, Expected: 'validationFileNameConfirmedList is: '}, 
  ...
  {Name: 'cErrorInvalidConstantsFileNameMessage01', Actual: msg.cErrorInvalidConstantsFileNameMessage01, Expected: 'ERROR: Please enter a valid constants file name(s) to validate.'},
  {Name: 'cWarningUserEnteredValidationDataFileNameMessage01', Actual: msg.cWarningUserEnteredValidationDataFileNameMessage01, Expected: 'WARNING: The specified validation file name is not available, please enter a valid file name and try again. Name not recognized: '},
  {Name: 'cWarningUserEnteredValidationDataFileNameMessage02', Actual: msg.cWarningUserEnteredValidationDataFileNameMessage02, Expected: 'WARNING: No valid constants validation file names were entered.'},
  {Name: 'cConstantsValidationFileNamesAre', Actual: msg.cConstantsValidationFileNamesAre, Expected: 'Constants validation file names are: '},
  {Name: 'cWarningUserEnteredValidationDataFileNameMessage03', Actual: msg.cWarningUserEnteredValidationDataFileNameMessage03, Expected: 'WARNING: You have to enter a file name to run constants validations of that file.'},
